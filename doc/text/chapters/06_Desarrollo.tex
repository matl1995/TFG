...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.47]{codigo-arcore}
...
En esta iteración se ha creado el diagrama de clases del sistema haciendo uso del lenguaje UML, dicho diagrama de clases se puede consultar en el Ápendice \ref{apendice-diagrama-de-clases}.
