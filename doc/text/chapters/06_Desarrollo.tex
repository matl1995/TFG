...
En esta iteración se ha llevado a cabo el documento de diseño de videojuegos (GDD), que se encuentra en la Sección \ref{documento-diseño-videojuegos}, dejando definido los como será el videojuego.\\

También se han llevado a cabo las historias de usuario que definen las situaciones en las que un usuario se encontrará cuando quiera llevar a cabo una acción en el juego, estas historias se pueden encontrar en el Apéndice \ref{historias-usuario}.\\

Por otro lado, se ha realizado la demo que se ha mostrado en la \textbf{Entrega 0}.\\
