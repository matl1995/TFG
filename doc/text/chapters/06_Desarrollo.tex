...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.2]{dice-2}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.21]{notes-2}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.12]{notes-3}
...
En rasgos mas generales, en esta iteración se ha llevado a cabo la pantalla de juego que es la pantalla central sobre la que se desarrollará el juego, ya que es la que puede escanear el mundo real, el resultado se muestra en la \textbf{Entrega 4}.\\
