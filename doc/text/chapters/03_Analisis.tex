...
\begin{itemize}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.15]{elements3d}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.15]{cards-notes}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.13]{cubes-button}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.15]{cards3delement}
