...
\begin{itemize}
  ...
  \begin{figure}[h]
    \centering
    \includegraphics[scale=0.2]{head-googleglass}
...
Como se puede observar en el estudio realizado, la mayoría de juegos de mesa que hacen uso de la realidad aumentada actualmente se basan en establecer todos los elementos sobre una superficie plana, sin embargo, solo unos pocos hacen uso de elementos físicos, lo que indica que hay un gran hueco para juegos que juntan componentes físicos con realidad aumentada, lo que permite que manteniendo una experiencia realista gracias a los elementos físicos, se pueda disfrutar de la espectacularidad de la realidad aumentada.
