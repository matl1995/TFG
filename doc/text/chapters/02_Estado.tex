...
\begin{itemize}
  \item La realidad aumentada es una tecnología que supondrá parte importante de las aplicaciones móviles en el futuro, ya que a pesar de estar empezando, ya se encuentra ciertamente avanzada para comenzar a ser utilizada, y el número de aplicaciones que esta ofrece es muy grande, abarcando desde el puro entretenimiento hasta el uso médico.
...
\begin{itemize}
  ...
  \item Se debe poder realizar ciertas tareas utilizando elementos físicos, para una vez mas mantener un realismo en el juego.
